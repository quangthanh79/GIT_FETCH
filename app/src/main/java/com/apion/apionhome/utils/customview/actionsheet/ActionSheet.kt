...
class ActionSheet {
    ...
    private val actionSheet by lazy { ActionSheet(context, data, isPhone) }
    ...
    private val recyclerviewAdapter by lazy { RecyclerviewAdapter(data, context, isPhone) }

    constructor(context: Context, data: MutableList<String>, isPhone: Boolean) {
