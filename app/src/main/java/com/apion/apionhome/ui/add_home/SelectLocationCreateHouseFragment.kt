...
class SelectLocationCreateHouseFragment :
    BindingFragmentBottomSheet<FragmentSelectLocationCreateHouseBinding>(
        FragmentSelectLocationCreateHouseBinding::inflate
    ) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!isClear) {
            ...
            viewModel.detailAddress.value = searchViewModelTmp.detailAddress.value
        } else {
